...
import InvitationEmail from '@f-doc/transactional/emails/invitation-email';
import { GroupUserRepo } from '@f-doc/db/repos/group/group-user.repo';
import InvitationAcceptedEmail from '@f-doc/transactional/emails/invitation-accepted-email';
import { TokenService } from '../../auth/services/token.service';
import { SessionService } from '../../session/session.service';
import { nanoIdGen } from '../../../common/helpers';
import { PaginationOptions } from '@f-doc/db/pagination/pagination-options';
import { executeWithCursorPagination } from '@f-doc/db/pagination/cursor-pagination';
...
export class WorkspaceInvitationService {
  ...
  async acceptInvitation(
    ...
    if (invitedByUser) {
      ...
      await this.mailService.sendToQueue({
        ...
        subject: `${newUser.name} has accepted your F-Doc invite`,
  ...
  async sendInvitationMail(
    ...
    await this.mailService.sendToQueue({
      to: inviteeEmail,
      subject: `${invitedByName} invited you to F-Doc`,
      template: emailTemplate,
    });
  }
}
