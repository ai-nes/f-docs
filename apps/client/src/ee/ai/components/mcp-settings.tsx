    ...
    <Stack gap="lg">
      {!hasAccess && (
        <Alert icon={<IconInfoCircle />} title={upgradeLabel} color="blue">
          {t(
            "MCP is only available in the F-Doc enterprise edition. Contact sales@docmost.com.",
          )}
        </Alert>
      )}
      ...
      {checked && (
        <div>
          ...
          <Text size="sm" c="dimmed" mt="xs">
            {t("Connect AI assistants with your F-Doc account via OAuth.")}
          </Text>
  ...
  return (
    <Group justify="space-between" wrap="nowrap" gap="xl" mt="md">
      <div>
        ...
        <Text size="sm" c="dimmed">
          {t(
            "AI assistants must connect with a F-Doc account via OAuth. API keys cannot be used with the MCP server.",
          )}
        </Text>
      </div>
